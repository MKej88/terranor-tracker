...
const EXTRA_TARGETS = [
  {
    ...
    notes: "Kommunal vei-drift og vedlikehold. Fireårskontrakt fra 1. oktober 2026 til 30. september 2030.",
  },
  {
    country: "Finland",
    label: "Kuhmo",
  ...
  },
  {
    ...
    locationName: "Vuosaari",
    latitude: 60.2070,
    longitude: 25.1420,
    source: "FMI",
    confidence: "official-reference-city-proxy",
    notes: "Kommunal områdereferanse 2024-2029 for Helsinki by.",
  },
  {
    country: "Finland",
    label: "Kajaani",
  ...
  },
  {
    ...
    locationName: "Raasepori",
    latitude: 59.9740,
    longitude: 23.4360,
    source: "FMI",
    confidence: "official-reference-city-proxy",
    notes: "Statlig veivedlikeholdsreferanse 2021-2026. Relevant gjennom avslutningen av 2026-kontraktsperioden.",
  },
];
